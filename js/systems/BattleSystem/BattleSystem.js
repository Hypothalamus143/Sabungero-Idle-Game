    ...
    async handleBattleEnd(victory, playerDamage, opponentDamage) {
        ...
        if (victory) {
            ...
            const id = (parseInt(Object.keys(this.playerStats.drops).pop() || "0") + 1).toString();
                ...
                const position = [Math.random() * window.app.screen.width * 0.4 + window.app.screen.width * 0.4, Math.random() * (window.app.screen.height * 0.125) + (window.app.screen.height * 0.75)];
